import { INIT, UPDATE_BALANCES, UPDATE_BALANCE, GET_CONTACT_CODE,
  RESET_STATE, RESOLVE_ENS_NAME, PURGE_STATE, GET_GAS_PRICE, SET_TRANSACTION_WARNING_STATE } from './constants';
...
export const setTransactionWarningState = (acceptation, neverShowAgain) => ({type: SET_TRANSACTION_WARNING_STATE, acceptation, neverShowAgain});
