...
export const EMAIL_SERVER_ENDPOINT = `https://cryptolife.status.im/api/${DAPP_ID}`;
...
export const RESET_NOTIFICATION_WARNINGS = 'RESET_NOTIFICATION_WARNINGS';

export const SET_HIDE_SIGNATURE_WARNING = 'SET_HIDE_SIGNATURE_WARNING';
