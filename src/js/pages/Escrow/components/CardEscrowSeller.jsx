...
// eslint-disable-next-line complexity
  render() {
    ...
    const {trade, showApproveScreen, fundEscrow, releaseEscrow, tokens, arbitrationDetails, feeMilliPercent} = this.props;
    ...
    switch (step) {
      ...
      case 2:
        component =
          <PreFund tokens={tokens} showFundButton={showFundButton} fundEscrow={fundEscrow} trade={trade}
