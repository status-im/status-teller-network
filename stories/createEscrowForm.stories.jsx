...
import CreateEscrowForm, {CreateEscrowFormComponent} from '../app/js/components/CreateEscrowForm';

const info = {inline: true, propTables: [CreateEscrowFormComponent], propTablesExclude: [CreateEscrowForm]};
